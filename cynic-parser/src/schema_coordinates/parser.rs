...
// sha3: acbe446ad339940715b71e8002456dbe7ae617a9b7ff72052e392624ff1209dc
...
mod __parse__SchemaCoordinate {
    ...
    ) -> Option<Result<SchemaCoordinate,__lalrpop_util::ParseError<usize, lexer::Token<'input>, crate::parser::AdditionalErrors>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            ...
            13 => {
                // __SchemaCoordinate = SchemaCoordinate => ActionFn(0);
    ...
    {
        // ArgumentCoordinate = MemberCoordinate, "(", Name, ":", ")" => ActionFn(8);
    ...
    {
        // DirectiveArgumentCoordinate = DirectiveCoordinate, "(", Name, ":", ")" => ActionFn(10);
        assert!(__symbols.len() >= 5);
        let __sym4 = __pop_Variant0(__symbols);
        let __sym3 = __pop_Variant0(__symbols);
        let __sym2 = __pop_Variant7(__symbols);
    ...
    {
        // DirectiveCoordinate = "@", Name => ActionFn(16);
    ...
    {
        // MemberCoordinate = TypeCoordinate, ".", Name => ActionFn(7);
    ...
    {
        // SchemaCoordinate = TypeCoordinate => ActionFn(1);
        let __sym0 = __pop_Variant9(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
    ...
    {
        // SchemaCoordinate = MemberCoordinate => ActionFn(2);
        let __sym0 = __pop_Variant6(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
    ...
    {
        // SchemaCoordinate = ArgumentCoordinate => ActionFn(3);
    ...
    {
        // SchemaCoordinate = DirectiveCoordinate => ActionFn(4);
        let __sym0 = __pop_Variant5(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
    ...
    {
        // SchemaCoordinate = DirectiveArgumentCoordinate => ActionFn(5);
    ...
    {
        // TypeCoordinate = Name => ActionFn(6);
